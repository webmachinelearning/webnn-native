...
HRESULT Device::Init()
{
    ...
    // DML validation has a bug when binding a resource using a custom-equivalent default heap type as output.
    // To workaround this DML bug, disable using custom heap types.
    // TODO: Remove once MSFT fixes it.
