...
typedef int (*ANeuralNetworksMemory_createFromFd_fn)(size_t size,
                                                     int protect,
                                                     int fd,
                                                     size_t offset,
...
typedef int (*ANeuralNetworksModel_setOperandValue_fn)(ANeuralNetworksModel* model,
                                                       int32_t index,
                                                       const void* buffer,
                                                       size_t length);
...
typedef int64_t (*SL_ANeuralNetworksDiagnosticCompilationInfo_getNnApiVersion_fn)(
    const ANeuralNetworksDiagnosticCompilationInfo* diagnosticCompilationInfo);

typedef const uint8_t* (*SL_ANeuralNetworksDiagnosticCompilationInfo_getModelArchHash_fn)(
    const ANeuralNetworksDiagnosticCompilationInfo* diagnosticCompilationInfo);

typedef const char* (*SL_ANeuralNetworksDiagnosticCompilationInfo_getDeviceIds_fn)(
    const ANeuralNetworksDiagnosticCompilationInfo* diagnosticCompilationInfo);
...
typedef uint64_t (*SL_ANeuralNetworksDiagnosticCompilationInfo_getCompilationTimeNanos_fn)(
    const ANeuralNetworksDiagnosticCompilationInfo* diagnosticCompilationInfo);

typedef bool (*SL_ANeuralNetworksDiagnosticCompilationInfo_isCachingEnabled_fn)(
    const ANeuralNetworksDiagnosticCompilationInfo* diagnosticCompilationInfo);

typedef bool (*SL_ANeuralNetworksDiagnosticCompilationInfo_isControlFlowUsed_fn)(
    const ANeuralNetworksDiagnosticCompilationInfo* diagnosticCompilationInfo);

typedef bool (*SL_ANeuralNetworksDiagnosticCompilationInfo_areDynamicTensorsUsed_fn)(
    const ANeuralNetworksDiagnosticCompilationInfo* diagnosticCompilationInfo);
...
typedef const uint8_t* (*SL_ANeuralNetworksDiagnosticExecutionInfo_getModelArchHash_fn)(
    const ANeuralNetworksDiagnosticExecutionInfo* diagnosticExecutionInfo);

typedef const char* (*SL_ANeuralNetworksDiagnosticExecutionInfo_getDeviceIds_fn)(
    const ANeuralNetworksDiagnosticExecutionInfo* diagnosticExecutionInfo);
...
typedef uint64_t (*SL_ANeuralNetworksDiagnosticExecutionInfo_getRuntimeExecutionTimeNanos_fn)(
    const ANeuralNetworksDiagnosticExecutionInfo* diagnosticExecutionInfo);

typedef uint64_t (*SL_ANeuralNetworksDiagnosticExecutionInfo_getDriverExecutionTimeNanos_fn)(
    const ANeuralNetworksDiagnosticExecutionInfo* diagnosticExecutionInfo);

typedef uint64_t (*SL_ANeuralNetworksDiagnosticExecutionInfo_getHardwareExecutionTimeNanos_fn)(
    const ANeuralNetworksDiagnosticExecutionInfo* diagnosticExecutionInfo);
...
typedef bool (*SL_ANeuralNetworksDiagnosticExecutionInfo_areDynamicTensorsUsed_fn)(
    const ANeuralNetworksDiagnosticExecutionInfo* diagnosticExecutionInfo);
