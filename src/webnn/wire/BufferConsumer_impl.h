...
#ifndef WEBNN_WIRE_BUFFERCONSUMER_IMPL_H_
#define WEBNN_WIRE_BUFFERCONSUMER_IMPL_H_

#include "webnn/wire/BufferConsumer.h"
...
#endif  // WEBNN_WIRE_BUFFERCONSUMER_IMPL_H_
