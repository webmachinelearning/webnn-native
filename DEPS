...
deps = {
  ...
  'third_party/DirectML': {
    'url': '{github_git}/microsoft/DirectML.git@4a144773c8deaa3caa47b0ebbbed1b4a0a7e972e',
    'condition': 'checkout_win',
  },
  # GPGMM support for fast DML allocation and residency management.
  'third_party/gpgmm': {
    'url': '{github_git}/intel/gpgmm.git@44476aa8f6210a2d3dbe2e020755e95ed1e3a7e4',
    'condition': 'checkout_win',
  },
  'third_party/oneDNN': {
    'url': '{github_git}/oneapi-src/oneDNN.git@a3ae819c9fe7e24d2dacdce21d59811f9faee9fb',
  },
  'third_party/XNNPACK': {
    'url': '{github_git}/google/XNNPACK.git@d3207e9e9e7d655f91971d327eabbd44cd4e8f4b'
  },
  'third_party/onnxruntime': {
    'url': '{github_git}/microsoft/onnxruntime.git@ac4f1bf9603967212333cf9c9e5487145e7c91bc',
