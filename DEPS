...
deps = {
  ...
  'third_party/DirectML': {
    'url': '{github_git}/microsoft/DirectML.git@ef779b63737f028e47a49d6ff2e7af5b41c67407',
    'condition': 'checkout_win',
  },
  # GPGMM support for fast DML allocation and residency management.
  'third_party/gpgmm': {
    'url': '{github_git}/intel/gpgmm.git@3ba2fcfc3402bc4a21596b9ef14200c703d96307',
    'condition': 'checkout_win',
  },
  'third_party/oneDNN': {
    'url': '{github_git}/oneapi-src/oneDNN.git@e3f4e451c68ab760c82b6280770d921d78442a03',
  },
  'third_party/XNNPACK': {
    'url': '{github_git}/google/XNNPACK.git@58051e2ed52d0fdedee033724cdcd56f73025a0d'
  },
  'third_party/onnxruntime': {
    'url': '{github_git}/microsoft/onnxruntime.git@1e34440c370d40085fad5fd1b1002b4a04c5991d',
