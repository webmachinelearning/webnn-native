...
IEStatusCode ie_model_add_pad(ie_model_t* model,
                              ie_operand_t* input,
  ...
  BEGINE_TRY
  *operand = model->object->AddPad(input, options);
  END_CATCH
...
IEStatusCode ie_model_add_reduce_mean(ie_model_t* model,
                                      ie_operand_t* input,
  ...
  BEGINE_TRY
  *operand = model->object->AddReduceMean(input, options);
  END_CATCH
...
IEStatusCode ie_model_add_sigmoid(ie_model_t* model,
                                  ie_operand_t* input,
                                  ie_operand_t** operand) {
  if (model == nullptr || input == nullptr) {
    return IEStatusCode::GENERAL_ERROR;
  ...
  BEGINE_TRY
  *operand = model->object->AddSigmoid(input);
  END_CATCH
...
IEStatusCode ie_model_add_tanh(ie_model_t* model,
  ...
  BEGINE_TRY
  *operand = model->object->AddTanh(input);
  END_CATCH
